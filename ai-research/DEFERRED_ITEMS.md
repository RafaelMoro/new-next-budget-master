...
- **Old repo:** `old-next-budget-master/src/features/Records/ExpensesPaid/`, `old-next-budget-master/src/shared/hooks/useSelectExpensesPaid.tsx`
...
- **Old repo:** `old-next-budget-master/src/features/Records/EditIncome.tsx`, `old-next-budget-master/src/app/edit-record/`
...
- **Old repo:** `old-next-budget-master/src/features/Records/EditTransfer.tsx`, `old-next-budget-master/src/app/edit-record/`
