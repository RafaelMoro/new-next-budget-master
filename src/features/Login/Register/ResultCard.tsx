...
import { SUCCESS_CREATE_USER_MESSAGE, SUCCESS_CREATE_USER_SPAN, SUCCESS_CREATE_USER_TITLE, SUCCESS_CREATE_USER_SECONDARY_MESSAGE } from "@/shared/constants/login.constants";
  ...
  return (
    <AnimateBox direction={direction} >
      <Card className="max-w-[400px]">
        ...
        <p className="text-xl text-black dark:text-white mb-8">{SUCCESS_CREATE_USER_SECONDARY_MESSAGE}</p>
